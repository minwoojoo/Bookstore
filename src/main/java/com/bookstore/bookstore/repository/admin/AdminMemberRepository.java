...
public interface AdminMemberRepository extends JpaRepository<Member, Long> {
    ...
    @Query("SELECT DISTINCT m FROM Member m " +
           ...
           "AND (:startDate IS NULL OR DATE(m.registrationDate) >= :startDate) " +
           "AND (:endDate IS NULL OR DATE(m.registrationDate) <= :endDate) " +
    ...
    Page<Member> findInactiveMembers(@Param("cutoffDate") LocalDate cutoffDate, Pageable pageable);
